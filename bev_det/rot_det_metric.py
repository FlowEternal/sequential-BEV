...
def eval_mAP(ROOT_DIR,
             VALID_DETECT_GROUND_TRUTH=None,
             VALID_DETECT_RESULT=None,
             use_07_metric = False,
             thres = 0.5):
    ...
    # TODO
    GT_PATH = VALID_DETECT_GROUND_TRUTH
    DR_PATH = VALID_DETECT_RESULT
    ...
    # ground_truth_files_list = ground_truth_files_list[0:11]
    gt_files = []
